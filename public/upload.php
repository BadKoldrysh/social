...
if (!isset($_POST['x']) && !isset($_FILES['image']['name'])) {
    // delete user temp image
    $temppath = __DIR__ . '/assets/images/profile_pics/' . $profile_id . '_temp.jpeg';
...
**********************************************/
    ...
    // Set file name
    $file_temp_name = $profile_id . '_original' . md5((string)time()) . 'n' . $type; // the temp file name
    $fullpath = $uploaddir . "/" . $file_temp_name; // the temp file path
    $file_name = $profile_id . '_temp.jpg'; // for the final resized image
...
**********************************************/
    ...
    // create new image using correnct php func
    ...
    $main = imagecreatetruecolor($main_width, (int)$main_height);
    imagecopyresampled($main, $src2, 0, 0, 0, 0, $main_width, (int)$main_height, $original_width, $original_height);
...
if (isset($_POST['x'])) {
    ...
    $finalname = $profile_id . md5((string)time());
    ...
    if ($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG') {
        ...
        imagejpeg($dst_r, __DIR__ . '/assets/images/profile_pics/' . $finalname . "n.jpeg", 90);
